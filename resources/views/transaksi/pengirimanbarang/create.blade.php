                                        ...
                                        <form action="{{ route('master.pengirimanbarang.store') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label class=" form-control-label">Toko Pengirim<span
                                                        style="color: red">*</span></label>
                                                <select class="form-control" name="toko_pengirim" id="toko_pengirim"
                                                    style="display: block;">
                                                    <option class="" value="" required>~Pilih Nama Toko~
                                                    </option>
                                                    @foreach ($toko as $tk)
                                            ...
                                            <div class="form-group">
                                                <label class=" form-control-label">Toko Penerima<span
                                                        style="color: red">*</span></label>
                                                <select class="form-control" name="toko_penerima" id="toko_penerima"
                                                    style="display: block;">
                                        ...
                                        @if ($pengiriman_barang)
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    <h4><i class="fa fa-home"></i> Nomor Resi <span
                                                            class="badge badge-secondary pull-right">{{ $pengiriman_barang->no_resi }}</span>
                                                    </h4>
                                                </li>
                                                <li class="list-group-item">
                                                    <h4><i class="fa fa-globe"></i> Toko Pengirim <span
                                                            class="badge badge-secondary pull-right">{{ $pengiriman_barang->toko->nama_toko }}</span>
                                                    </h4>
                                                </li>
                                                <li class="list-group-item">
                                                    <h4><i class="fa fa-globe"></i> Nama Pengirim <span
                                                            class="badge badge-secondary pull-right">{{ $pengiriman_barang->user->nama }}</span>
                                                    </h4>
                                                </li>
                                                <li class="list-group-item">
                                                    <h4><i class="fa fa-globe"></i> Ekspedisi <span
                                                            class="badge badge-secondary pull-right">{{ $pengiriman_barang->ekspedisi }}</span>
                                                    </h4>
                                                </li>
                                                <li class="list-group-item">
                                                    <h4><i class="fa fa-globe"></i> Toko Penerima <span
                                                            class="badge badge-secondary pull-right">{{ $pengiriman_barang->tokos->nama_toko }}</span>
                                                    </h4>
                                                </li>
                                                <li class="list-group-item">
                                                    <h4><i class="fa fa-map-marker"></i> &nbsp;Tanggal Kirim <span
                                                            class="badge badge-secondary pull-right">{{ $pengiriman_barang->tgl_kirim }}</span>
                                                    </h4>
                                                </li>
                                            </ul>
                                            <br>
                                                    ...
                                                    <div class="item-group">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <!-- Jenis Barang -->
                                                                <p>ID Toko Pengirim:
                                                                    {{ $pengiriman_barang->toko_pengirim }}</p>
    ...
    `;
                ...
                document.querySelectorAll('.jumlah-item, .harga-barang').forEach(function(input) {
                    input.addEventListener('input', function() {
                        let hppBaru = parseFloat(document.querySelector('.card-text strong.hpp-baru')
                            .textContent.replace('Rp ', '').replace(/\./g, '')) || 0;
                        calculateHPP(hppBaru);
                    });
                });
